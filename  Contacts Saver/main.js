...
addBtn.addEventListener('click', function () {
    if (checkInputFields([names, address, number])) {
        setMessage("success", "Record added successfully!");
        id++;
        const contact = new Contact(id, names.value, address.value, number.value);
...
function addToList(item) {
    ...
    newRecordDiv.innerHTML = `
        ...
        <div class = "record-el">
            ...
            <span id = "name-content">${item.names}</span>
        </div>
        <div class = "record-el">
...
// function doNotRetriveWhenReloaded(event) {
//     if (event.target != retriveBtn) {
//         preventDefault()
//     }
// }
